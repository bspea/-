...
<%
	ArrayList<Member> list4 = (ArrayList<Member>)request.getSession().getAttribute("friendsList");
	Member member4 = (Member)request.getSession().getAttribute("member");
%>
...
<head>
                                                    ...
                                                    <div class="myTLine_Cover" id="myTLine_u_0_10">
                                                        ...
                                                        <div class="myTLine_coverImage" id="myTLine_u_0_z">
                                                            ...
                                                            <div title="커버 사진" class="myTLine_CoverWrap" id="myTLine_fbCoverImageContainer">
	                                                            <!-- 커버 이미지 경로 -->
	                                                            <img width="849" height="315" class="myTLine_ox1 myTLine_21y0" id="myTLine_u_jsonp_2-_f"src="<%=member4.getCoverImage() %>">
                                                            </div>
                                                            ...
                                                            <div class="myTLine_6a myTLine_uiPopover myTLine_30vx myTLine_5v-0" id="myTLine_fbProFileCoverPhotoSelector">
                                                                ...
                                                                -->
                                                                <% if(loginUser != null && member4.getmNo() == loginUser.getmNo()){ %>
                                                            ...
                                                            <ul class="myTLine_6_7 myTLine_Contents_Clearfix" id="myTLine_u_0_13">
                                                                ...
                                                                <li>
                                                                   <a id="myTLine_friends" class="myTLine_6-6" href="">
                                                                       	친구
                                                                       <!-- 친구 숫자 넣기 -->
                                                                       <span class="myTLine_gs6"><%=list4.size() %></span>
                                                                       <span class="myTLine_513x"></span>
                                                                   </a> 
                                                                </li>
                                                            </ul>
	...
	<!-- 친구페이지  -->
    <%@include file= "/views/sira/ace4_MyTimeLine_Menu3.jsp" %>
	...
	$("#myTLine_u_0_15").click(function(){
	   	location.href="<%=contextPath%>/timeLines.bo";
	   	return false;
	  });
